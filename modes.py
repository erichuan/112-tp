'''
Framework taken from animation demo notes
'''
from tkinter import *
...
def splashScreenRedrawAll(canvas, data):
    canvas.create_text(data.width/2, data.height/2-20,
                       text="Welcome to Eric's 112 TP homescreen!", font="Arial 26 bold")
    canvas.create_text(data.width/2, data.height/2+20,
                       text="It will be a create your own adventure interactive game.", font="Arial 20")
    canvas.create_text(data.width/2, data.height/2+40,
                       text="You will be faced with different scenarios where you will have to make decisions about what to do, what the circumstances are.", font="Arial 10")
    canvas.create_text(data.width/2, data.height/2+60, text="You may also have to complete some activities in order to advance in the narrative.", font="Arial 10")
    canvas.create_text(data.width/2, data.height/2+80, text="In the end, your decisions will be compiled, summarized, and analyzed based on organizational behavior theory", font="Arial 10")
    canvas.create_text(data.width/2, data.height/2+100,
                       text="as well as learn about your strengths, weaknesses as a leader and what you can do.", font="Arial 10")
